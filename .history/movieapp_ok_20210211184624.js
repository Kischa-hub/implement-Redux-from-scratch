...
const render = (movietitle, moviecateogry, movieImage) => {
  var h1 = document.createElement("h1");
  h1.textContent = movietitle;

  var h3 = document.createElement("h3");
  h1.textContent = moviecateogry;
...
store.subscribe(() => {
  ...
  // document.body.innerText = store.getState().movies.map((m) => render(m.name, m.details));
