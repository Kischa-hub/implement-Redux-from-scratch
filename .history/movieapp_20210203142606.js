...
store.dispatch({ type: 'ADDMOVIE', payload: { movieId:"m"+(Math.floor(Math.random()*100)),movieName:movie.movieName,realseDate:movie.movieRealseDate,movieURL:movie.movieURL,moviePeriod:movie.moviePeriod }});
